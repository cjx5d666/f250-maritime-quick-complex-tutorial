...
STOP_LOG="${STOP_LOG:-${RUN_ROOT}/stop_${STAMP}.log}"
...
Useful environment overrides:
  ...
  STOP_LOG=...                  default: <RUN_ROOT>/stop_<timestamp>.log
...
patterns=(
  ...
  "[m]aritime_depth_cloud_adapter.py"
  "[e]go_planner_node"
  "[t]raj_server"
  "[w]aypoint_generator"
...
if [ -L "${RUN_ROOT}/current" ] || [ -d "${RUN_ROOT}/current" ]; then
